...
if($_SESSION['role']=='admin'){
    ...
    <form method='POST' action='add_noti.php'>
    <h3>Create New Notification:</h3>
    <hr>
    <input name='posttitle' type='text' class='form-control' id='' placeholder='Enter Post Title'><br>

    <textarea name='postdes' type='text' class='form-control' id='' placeholder='Enter Description'  ></textarea><br>
...
if ($result->num_rows > 0) 
    {
        ...
        { 
            ...
            <pre style='background-color: ;border-radius: 5px;margin-top: 10px; box-shadow:2px 2px 2px 2px grey;'>
